            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        <h1 class="h2">
                            <i class="fas fa-plus-circle me-2"></i> Novo Tipo de Intimação
                        </h1>
                        <div class="text-end">
                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            <h5 class="mb-0">
                                <i class="fas fa-bell me-2"></i> Dados do Tipo de Intimação
                            </h5>
                        </div>
                        <div class="card-body">
                            <form action="<?= URL ?>/ciri/adicionarTipoIntimacao" method="POST">
                                <div class="row">
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="<?= URL ?>/ciri/gerenciarTiposIntimacao" class="btn btn-danger">
