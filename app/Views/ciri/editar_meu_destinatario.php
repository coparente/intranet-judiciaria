            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        ...
                        <div class="text-end">
                            <a href="<?= URL ?>/ciri/visualizarMeuProcesso/<?= $dados['destinatario']->processo_id ?>" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= URL ?>/ciri/editarMeuDestinatario/<?= $dados['destinatario']->id ?>" method="POST">
