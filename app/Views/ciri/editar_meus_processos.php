            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        ...
                        <div class="text-end">
                            <a href="<?= URL ?>/ciri/visualizarMeuProcesso/<?= $dados['id'] ?>" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= URL ?>/ciri/editarMeusProcessos/<?= $dados['id'] ?>" method="POST">
                                <div class="row">
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="<?= URL ?>/ciri/meusProcessos" class="btn btn-danger">
