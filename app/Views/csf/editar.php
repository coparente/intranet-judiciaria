            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        <h1 class="h2">
                            <i class="fas fa-edit me-2"></i> Editar Visita Técnica
                        </h1>
                        <div class="text-end">
                            <a href="<?= URL ?>/csf/visualizar/<?= $dados['id'] ?>" class="btn btn-secondary btn-sm">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?= URL ?>/csf/editar/<?= $dados['id'] ?>">
                                ...
                                <h4 class="mt-4 mb-3">Identificação da Área</h4>
                                <hr>
