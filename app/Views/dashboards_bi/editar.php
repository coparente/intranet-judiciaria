            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        <h1 class="h2">
                            <i class="fas fa-edit me-2"></i> Editar Dashboard BI
                        </h1>
                        <div class="text-end">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="<?= URL ?>/dashboardsbi/editar/<?= $dados['id'] ?>" method="post">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="categoria" id="categoria" class="form-control">
                                            <option value="CIVEL" <?= $dados['categoria'] == 'CIVEL' ? 'selected' : '' ?>>CIVEL</option>
                                            <option value="CEM" <?= $dados['categoria'] == 'CEM' ? 'selected' : '' ?>>CEM</option>
                                        </select>
                                        <small class="text-muted">Ex: Financeiro, RH, Operacional</small>
                                    </div>
                                </div>
