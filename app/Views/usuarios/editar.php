                        ...
                        <div class="col-md-12">
                            <div class="box box-info">
                                <div class="box-header with-border" id="tituloMenu">
                                    <h3 id="tabelas" class="box-title"><i class="fas fa-user-edit me-2"></i> ID: <?= $dados['id'] ?> - <?= $dados['nome'] ?></h3>
                                ...
                                <fieldset aria-labelledby="tituloMenu">
                                    <div class="card-body">
                                        ...
                                        <form action="<?= URL ?>/usuarios/editar/usuario/<?= $dados['id'] ?>" method="POST" class="needs-validation" novalidate>
                                            <div class="row g-3">
                                                <!-- Nome -->
                                            ...
                                            <?php if (isset($dados['ultimo_acesso'])): ?>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="mb-0 text-muted">
                                                                    <?= $dados['ultimo_acesso'] ? date('d/m/Y H:i', strtotime($dados['ultimo_acesso'])) : 'Nunca acessou' ?>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
